...
//		activeRequestClassesInOverload();
		...
		if (healthy_threads_length < min_threadpool_size) {
			// ��������̸߳���С����С�̳߳ش�С���򲹳���Ӧ�Ĳ��
			if (debugEnabled()) {
				System.out.println("��������̸߳���С����С�̳߳ش�С���򲹳���Ӧ�Ĳ��");
				System.out.println("");
				System.out.println("****************");
			}
			//  ��������̸߳���С����С�̳߳ش�С������һ����
//			requestmanager.incrPoolSize(j2 - j1);
		...
		if (queue_length > 0 && zeroCompletedDuration > 2) {
			// �ȴ����в�Ϊ�գ�����������Intervalû��������ɣ�������4s
			requestmanager.incrPoolSize(1);
			if (debugEnabled()) {
				System.out.println("�ȴ����в�Ϊ�գ�����������Intervalû��������ɣ������̳߳����� +1");
				System.out.println("");
				System.out.println("****************");
			}
			return;
		...
		if (maxY == 0 && work_completed_per_second_duration > Y_THRESHOLD_FOR_CPU_INTENSIVE_LOAD) {
			// ��һ������������ÿ����ɵ�����������Y_THRESHOLD_FOR_CPU_INTENSIVE_LOAD��������߳�����CPU����
			reset(requestmanager, healthy_threads_length);
			if (debugEnabled()) {
				System.out
						.println("��һ������������ÿ����ɵ�����������Y_THRESHOLD_FOR_CPU_INTENSIVE_LOAD��������߳�����CPU����");
				System.out.println("");
				System.out.println("****************");
			}
			return;
