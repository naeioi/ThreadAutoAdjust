...
public class WorkManagerShutdownTriggerImpl
    extends com.onceas.descriptor.wm.impl.WorkManagerShutdownTriggerTypeImpl
    implements com.onceas.descriptor.wm.WorkManagerShutdownTrigger, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.onceas.descriptor.wm.impl.runtime.UnmarshallableObject, com.onceas.descriptor.wm.impl.runtime.XMLSerializable, com.onceas.descriptor.wm.impl.runtime.ValidatableObject
{
    ...
    private final static Class PRIMARY_INTERFACE_CLASS() {
        return (com.onceas.descriptor.wm.WorkManagerShutdownTrigger.class);
    }
...
+".onceas.descriptor.wm.MaxStuckThreadTimet\u0000+http://java.sun.c"
+"om/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bpp"
+"sq\u0000~\u0000\u000fq\u0000~\u0000\u0013psq\u0000~\u0000\u0014q\u0000~\u0000\u0013pq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000+com.onceas.d"
+"escriptor.wm.TagStringValueTypeq\u0000~\u0000\"sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0014q\u0000~\u0000\u0013psr\u0000\u001b"
...
+"\u0000~\u00007sq\u0000~\u0000\u001et\u0000\u0004typet\u0000)http://www.w3.org/2001/XMLSchema-instanc"
+"eq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0015max-stuck-thread-timet\u0000\u001bhttp://www.ios.ac.cn/"
+"onceassq\u0000~\u0000\u000bppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000\u000fq\u0000~\u0000\u0013psq\u0000~\u0000\u0014q\u0000~\u0000\u0013pq\u0000~\u0000\u0017"
+"q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000)com.onceas.descriptor.wm.StuckThreadCount"
+"q\u0000~\u0000\"sq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000\u000fq\u0000~\u0000\u0013psq\u0000~\u0000\u0014q\u0000~"
+"\u0000\u0013pq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001eq\u0000~\u0000*q\u0000~\u0000\"sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0014q\u0000~\u0000\u0013pq\u0000~\u00000q"
+"\u0000~\u0000@q\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0012stuck-thread-countq\u0000~\u0000Esq\u0000~\u0000\u000bppsq\u0000~\u0000\u0014q\u0000~\u0000\u0013"
+"pq\u0000~\u00000q\u0000~\u0000@q\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u001dwork-manager-shutdown-triggerq\u0000~\u0000Es"
...
+"ol;xp\u0000\u0000\u0000\u0011\u0001pq\u0000~\u0000\nq\u0000~\u0000\u000eq\u0000~\u0000&q\u0000~\u0000Hq\u0000~\u0000Pq\u0000~\u0000\u0011q\u0000~\u0000\'q\u0000~\u0000Iq\u0000~\u0000Qq\u0000~\u0000"
+"+q\u0000~\u0000Tq\u0000~\u0000Xq\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000Fq\u0000~\u0000$q\u0000~\u0000Nx"));
        }
        ...
        extends com.onceas.descriptor.wm.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public Object owner() {
            return WorkManagerShutdownTriggerImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("max-stuck-thread-time" == ___local)&&("http://www.ios.ac.cn/onceas" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.onceas.descriptor.wm.impl.WorkManagerShutdownTriggerTypeImpl)WorkManagerShutdownTriggerImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("max-stuck-thread-time" == ___local)&&("http://www.ios.ac.cn/onceas" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.onceas.descriptor.wm.impl.WorkManagerShutdownTriggerTypeImpl)WorkManagerShutdownTriggerImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
