...
public class FairShareRequestClassTypeImpl implements com.onceas.descriptor.wm.FairShareRequestClassType, com.sun.xml.bind.JAXBObject, com.onceas.descriptor.wm.impl.runtime.UnmarshallableObject, com.onceas.descriptor.wm.impl.runtime.XMLSerializable, com.onceas.descriptor.wm.impl.runtime.ValidatableObject
{

    protected com.onceas.descriptor.wm.TagStringValueType _FairShare;
    ...
    private final static Class PRIMARY_INTERFACE_CLASS() {
        return (com.onceas.descriptor.wm.FairShareRequestClassType.class);
    }

    public com.onceas.descriptor.wm.TagStringValueType getFairShare() {
        return _FairShare;
    }

    public void setFairShare(com.onceas.descriptor.wm.TagStringValueType value) {
        _FairShare = value;
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (_FairShare instanceof javax.xml.bind.Element) {
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _FairShare), "FairShare");
        } else {
            context.startElement("http://www.ios.ac.cn/onceas", "fair-share");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _FairShare), "FairShare");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _FairShare), "FairShare");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _FairShare), "FairShare");
            context.endElement();
        }
...
+"\u0012q\u0000~\u0000\u0011pq\u0000~\u0000\u0015q\u0000~\u0000\u0019q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\"com.onceas.descriptor.wm.Fair"
+"Shareq\u0000~\u0000 sq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\rq\u0000~\u0000\u0011psq\u0000~"
+"\u0000\u0012q\u0000~\u0000\u0011pq\u0000~\u0000\u0015q\u0000~\u0000\u0019q\u0000~\u0000\u001bsq\u0000~\u0000\u001cq\u0000~\u0000(q\u0000~\u0000 sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0012q\u0000~\u0000\u0011pq"
+"\u0000~\u0000.q\u0000~\u0000>q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\nfair-shareq\u0000~\u0000Csr\u0000\"com.sun.msv.gramma"
...
+"q\u0000~\u0000Lx"));
        ...
        extends com.onceas.descriptor.wm.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public Object owner() {
            return FairShareRequestClassTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        return ;
                    case  1 :
                        if (("fair-share" == ___local)&&("http://www.ios.ac.cn/onceas" == ___uri)) {
                            _FairShare = ((FairShareImpl) spawnChildFromEnterElement((FairShareImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("fair-share" == ___local)&&("http://www.ios.ac.cn/onceas" == ___uri)) {
                            context.pushAttributes(__atts, true);
                ...
                try {
                    switch (state) {
                        case  2 :
                            ...
                            return ;
                        case  5 :
                            _Name = ((TagStringValueTypeImpl) spawnChildFromText((TagStringValueTypeImpl.class), 6, value));
                            return ;
                        case  3 :
                            _FairShare = ((TagStringValueTypeImpl) spawnChildFromText((TagStringValueTypeImpl.class), 4, value));
                            return ;
                    }
