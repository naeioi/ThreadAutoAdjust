...
public class WmImpl
    extends com.onceas.descriptor.wm.impl.WmTypeImpl
    implements com.onceas.descriptor.wm.Wm, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.onceas.descriptor.wm.impl.runtime.UnmarshallableObject, com.onceas.descriptor.wm.impl.runtime.XMLSerializable, com.onceas.descriptor.wm.impl.runtime.ValidatableObject
{
    ...
    private final static Class PRIMARY_INTERFACE_CLASS() {
        return (com.onceas.descriptor.wm.Wm.class);
    }
    ...
    {
        context.startElement("http://www.ios.ac.cn/onceas", "wm");
...
+"amespaceURIq\u0000~\u0000!xq\u0000~\u0000\u001ct\u0000&com.onceas.descriptor.wm.OnceasServ"
+"lett\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000q\u0000~\u0000\u0011"
+"p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0016q\u0000~\u0000\u0011pq\u0000~\u0000\u0019q\u0000~\u0000"
+"\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000*com.onceas.descriptor.wm.OnceasServletTypeq\u0000~"
...
+"org/2001/XMLSchema-instanceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u000eonceas-servlett\u0000\u001bht"
+"tp://www.ios.ac.cn/onceasq\u0000~\u0000\u001fsq\u0000~\u0000\u000bppsq\u0000~\u0000\u000bq\u0000~\u0000\u0011psq\u0000~\u0000\u0000q\u0000~\u0000"
+"\u0011p\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0016q\u0000~\u0000\u0011pq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000$c"
+"om.onceas.descriptor.wm.WorkManagerq\u0000~\u0000$sq\u0000~\u0000\u0000q\u0000~\u0000\u0011p\u0000sq\u0000~\u0000\u0007p"
+"psq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0016q\u0000~\u0000\u0011pq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000"
+"~\u0000 t\u0000(com.onceas.descriptor.wm.WorkManagerTypeq\u0000~\u0000$sq\u0000~\u0000\u000bpps"
+"q\u0000~\u0000\u0016q\u0000~\u0000\u0011pq\u0000~\u00002q\u0000~\u0000Bq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\fwork-managerq\u0000~\u0000Gq\u0000~\u0000\u001fsq\u0000"
+"~\u0000\u000bppsq\u0000~\u0000\u0016q\u0000~\u0000\u0011pq\u0000~\u00002q\u0000~\u0000Bq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u0002wmq\u0000~\u0000Gsr\u0000\"com.sun."
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("wm" == ___local)&&("http://www.ios.ac.cn/onceas" == ___uri)) {
                    ...
                    case  1 :
                        if (("onceas-servlet" == ___local)&&("http://www.ios.ac.cn/onceas" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.onceas.descriptor.wm.impl.WmTypeImpl)WmImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("onceas-servlet" == ___local)&&("http://www.ios.ac.cn/onceas" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.onceas.descriptor.wm.impl.WmTypeImpl)WmImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.onceas.descriptor.wm.impl.WmTypeImpl)WmImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.onceas.descriptor.wm.impl.WmTypeImpl)WmImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.onceas.descriptor.wm.impl.WmTypeImpl)WmImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.onceas.descriptor.wm.impl.WmTypeImpl)WmImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
